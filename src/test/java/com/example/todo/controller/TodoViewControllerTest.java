...
class TodoViewControllerTest {
    ...
    class ListTodos {
        ...
        void shouldFallBackToFilteredWithEmptySearch() throws Exception {
            Page<TodoResponse> page = new PageImpl<>(Arrays.asList(sampleResponse));
            when(todoService.getFilteredTodos(any(), any(), anyInt(), anyInt(), anyString(), anyString()))
                    .thenReturn(page);
            when(todoService.getTodoStatistics()).thenReturn(sampleStats);
    ...
    class CreateTodo {
        ...
        void shouldReturnFormWithErrors() throws Exception {
            mockMvc.perform(post("/todos/new")
                            .param("title", "")
                            .param("priority", "MEDIUM")
                            .param("status", "PENDING"))
    ...
    class ShowEditForm {
        ...
        @Test
        @DisplayName("Should show edit form with existing todo data")
    ...
    class UpdateTodo {
        ...
        @Test
        @DisplayName("Should return form with errors when update validation fails")
