...
class TodoViewControllerTest {
    ...
    class ListTodos {
        ...
        @Test
        @DisplayName("Should list todos with status and priority filters")
        void shouldListTodosWithFilters() throws Exception {
            Page<TodoResponse> page = new PageImpl<>(Arrays.asList(sampleResponse));
    ...
    class ShowEditForm {
        ...
        @Test
        @DisplayName("Should show edit form when dueDate is null")
    ...
    class UpdateTodo {
        ...
        @Test
        @DisplayName("Should return form on validation error during update")
        void shouldReturnFormOnValidationErrorDuringUpdate() throws Exception {
            mockMvc.perform(post("/todos/1/edit")
                            .param("title", "")
                            .param("priority", "MEDIUM")
                            .param("status", "PENDING"))
    ...
    @Nested
    @DisplayName("POST /todos/{id}/toggle - Toggle Completion")
    class ToggleCompletion {

        @Test
        @DisplayName("Should toggle todo and redirect")
        void shouldToggleTodoAndRedirect() throws Exception {
