...
class TodoViewControllerTest {
    ...
    class ListTodos {
        ...
        @Test
        @DisplayName("Should list todos with empty search (falls through to filtered)")
    ...
    class ViewTodo {
        ...
        @Test
        @DisplayName("Should view a todo")
        void shouldViewTodo() throws Exception {
    ...
    class UpdateTodo {
        ...
        void shouldReturnFormOnUpdateValidationErrors() throws Exception {
            mockMvc.perform(post("/todos/1/edit")
                            .contentType(MediaType.APPLICATION_FORM_URLENCODED)
                            .param("title", "")
                            .param("priority", "MEDIUM")
