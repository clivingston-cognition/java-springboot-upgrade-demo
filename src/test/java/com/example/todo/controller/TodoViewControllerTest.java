...
class TodoViewControllerTest {
    ...
    class ListTodos {
        ...
        @Test
        @DisplayName("Should list todos without search")
        ...
        @Test
        @DisplayName("Should ignore blank search and use filtered todos")
        ...
        @Test
        @DisplayName("Should pass status and priority filters")
        void shouldPassFilters() throws Exception {
            Page<TodoResponse> page = new PageImpl<>(Arrays.asList(sampleResponse));
            when(todoService.getFilteredTodos(eq(TodoStatus.PENDING), eq(Priority.HIGH), anyInt(), anyInt(), anyString(), anyString()))
                    .thenReturn(page);
            when(todoService.getTodoStatistics()).thenReturn(sampleStats);
    ...
    class CreateTodo {
        ...
        @Test
        @DisplayName("Should return form on validation errors")
    ...
    class ViewTodo {
        ...
        @Test
        @DisplayName("Should view todo detail")
        void shouldViewTodoDetail() throws Exception {
    ...
    class ShowEditForm {
        ...
        void shouldShowEditFormWithExistingData() throws Exception {
    ...
    class UpdateTodo {
        ...
        @Test
        @DisplayName("Should return form on validation errors during update")
        void shouldReturnFormOnValidationErrorsDuringUpdate() throws Exception {
            mockMvc.perform(post("/todos/1/edit")
                            .param("title", "")
                            .param("priority", "MEDIUM")
                            .param("status", "PENDING"))
    ...
    class ToggleComplete {
        ...
        @Test
        @DisplayName("Should toggle completion and redirect")
